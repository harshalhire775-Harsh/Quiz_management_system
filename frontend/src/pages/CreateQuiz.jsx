...
const CreateQuiz = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 relative overflow-hidden font-sans selection:bg-blue-500/30 selection:text-blue-900">
            ...
            <div className="relative z-10 p-6 md:p-10 max-w-3xl mx-auto">
                ...
                >
                    <div className="flex justify-start items-center mb-6 relative">
                        <button
                            onClick={() => navigate(-1)}
                            className="flex items-center gap-2 text-slate-400 hover:text-blue-600 transition-all font-bold group px-4 py-2 rounded-full hover:bg-white/80"
                        >
                    ...
                    <h1 className="text-4xl md:text-5xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-slate-900 via-blue-800 to-blue-900 mb-3 drop-shadow-sm">
                        Create New Quiz
                    </h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <motion.div
                        ...
                        className="bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-xl shadow-slate-200/50 border border-white/50 p-6 md:p-8 relative overflow-hidden group hover:shadow-blue-500/10 transition-all duration-500"
                    >
                        <div className="flex items-center gap-4 mb-6 border-b border-slate-100 pb-6">
                            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 text-white flex items-center justify-center shadow-lg shadow-blue-500/30">
                        ...
                        <div className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-4 rounded-xl bg-slate-50/50 border-2 border-slate-100 hover:border-blue-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none font-bold text-lg text-slate-800 placeholder-slate-400 transition-all"
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full px-5 py-4 rounded-xl bg-slate-50/50 border-2 border-slate-100 hover:border-blue-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none font-medium text-slate-700 placeholder-slate-400 transition-all resize-none"
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-5 py-4 rounded-xl bg-slate-50/50 border-2 border-slate-100 hover:border-blue-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none font-bold text-slate-800 placeholder-slate-400 transition-all"
                                    ...
                                    {['All', 'FY', 'SY', 'TY'].map((year) => (
                                        <button
                                            ...
                                            className={`py-3 rounded-xl font-black text-sm transition-all border-2 ${formData.targetYear === year
                                                ? 'bg-blue-600 border-blue-600 text-white shadow-lg shadow-blue-500/30 active:scale-95'
                        ...
                        <div className="mt-6 pt-6 border-t border-slate-100">
                            ...
                            >
                                <div className={formData.allowedAttempts === 1 ? 'text-white' : 'text-slate-700'}>
                                    ...
                                    <p className={`text-xs ${formData.allowedAttempts === 1 ? 'text-blue-200' : 'text-slate-500'}`}>Enable strict mode</p>
                                </div>
                    ...
                    <motion.button
                        ...
                        type="submit"
                        disabled={loading}
                        className="w-full py-5 rounded-[1.5rem] bg-gradient-to-r from-slate-900 to-blue-900 text-white font-black text-xl shadow-2xl shadow-blue-900/30 hover:shadow-blue-900/50 transition-all relative overflow-hidden group"
                    >

...
const About = () => {
    return (
        <div className="min-h-screen bg-white text-slate-800 font-sans overflow-x-hidden selection:bg-blue-500/30 selection:text-blue-900">

            {/* 1. Hero Section & Who We Are */}
            <section className="relative pt-6 pb-16 md:pt-10 md:pb-20 overflow-hidden">
                {/* Background Decor */}
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-500/10 rounded-full blur-[100px] -z-10 translate-x-1/2 -translate-y-1/2"></div>
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <motion.div
                            ...
                            className="space-y-6"
                        >
                            <div className="inline-block px-4 py-2 bg-blue-50 rounded-full border border-blue-100/50">
                                <span className="text-blue-600 font-bold text-xs tracking-[0.2em] uppercase">About The Project</span>
                            </div>

                            <h1 className="text-4xl md:text-6xl font-[1000] text-slate-900 leading-[1.1] tracking-tight">
                                Empowering Learners Through <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">Smart Quizzes</span>
                            </h1>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <span className="text-blue-600 font-bold tracking-[0.2em] uppercase text-xs mb-3 block">Target Audience</span>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                        ...
                        <motion.div
                            whileHover={{ y: -5 }}
                            className="p-8 rounded-[2.5rem] bg-blue-50 border border-blue-100 relative overflow-hidden group"
                        >
                            <div className="absolute top-0 right-0 w-40 h-40 bg-blue-500/10 rounded-full blur-3xl -mr-10 -mt-10"></div>
                            <div className="relative z-10">
                                <div className="w-16 h-16 bg-blue-600 rounded-2xl text-white flex items-center justify-center text-3xl mb-6 shadow-lg shadow-blue-600/30">
                                    <FaUserGraduate />
                                </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            <motion.div
                                ...
                                whileHover={{ y: -5 }}
                                className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100 hover:shadow-xl hover:border-blue-500/30 transition-all duration-300"
                            >
                                <div className="w-12 h-12 bg-blue-50 rounded-xl text-blue-600 flex items-center justify-center mb-6 text-xl">
                                    {feature.icon}
                                </div>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <span className="text-blue-600 font-bold tracking-[0.2em] uppercase text-xs mb-3 block">The Advantage</span>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-2 gap-6 relative z-10">
                                ...
                                <div className="p-4 bg-white/10 rounded-2xl backdrop-blur-sm border border-white/10">
                                    <FaLayerGroup className="text-blue-400 mb-3 text-2xl" />
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            { title: "Integrity", desc: "We ensure fairness and honesty in every quiz result.", color: "bg-cyan-500" },
                            { title: "User-Centric", desc: "Everything we build is designed with the user experience in mind.", color: "bg-blue-500" }
                        ].map((val, i) => (
                            <motion.div
                                key={i}
                                whileHover={{ y: -10 }}

...
export const showConfirmAlert = async (title, text, confirmButtonText = 'Yes, Proceed') => {
  return MySwal.fire({
    ...
    customClass: {
      ...
      confirmButton: 'bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold rounded-xl px-8 py-3.5 shadow-lg shadow-red-500/30 transform transition-all text-sm',
      cancelButton: 'bg-slate-100 hover:bg-slate-200 text-slate-600 font-bold rounded-xl px-6 py-3.5 transition-all text-sm ml-3',
      actions: 'gap-3 mt-8'
    },
